...
// // --- Go back to Normal Mode (Button20) ---
...
void loop() {
  ...
  if (!isPlaying) {
    ...
    tft.setCursor(0, 60, 2);  // Move cursor to position for button display
